<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="container">
		<a class="navbar-brand" href="<?= base_url('home') ?>">
			<img src="<?= base_url() ?>/images/logo/logo1.png" width="90" height="57" class="d-inline-block align-top" alt="logo" loading="lazy">
		</a>
					...
					<?php if($this->session->userdata('role') == 2) : ?>
						...
						<li class="nav-item dropdown active">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="<?= base_url('home/kategori/aksesoris') ?>">
									<i class="fas fa-user-cog"></i>
									Aksesoris
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/baju') ?>">
									<i class="fas fa-shopping-bag"></i>
									Baju
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/celana') ?>">
									<i class="fas fa-key"></i>
									Celana
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/elektronik') ?>">
									<i class="fas fa-sign-out-alt"></i>
									Elektronik
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/furniture') ?>">
									<i class="fas fa-user-cog"></i>
									Furniture
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/hobi') ?>">
									<i class="fas fa-shopping-bag"></i>
									Hobi
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/make_up') ?>">
									<i class="fas fa-key"></i>
									Make Up
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/sepatu') ?>">
									<i class="fas fa-sign-out-alt"></i>
									Sepatu
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/peralatan_bayi') ?>">
									<i class="fas fa-shopping-bag"></i>
									Peralatan Bayi
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/skincare') ?>">
									<i class="fas fa-key"></i>
									Skincare
								</a>
								<a class="dropdown-item" href="<?= base_url('home/kategori/tas') ?>">
									<i class="fas fa-sign-out-alt"></i>
									Tas
								</a>
						</li>
