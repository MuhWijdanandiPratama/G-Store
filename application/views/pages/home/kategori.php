...
<div class="container">
	<div class="row mt-5">
		<div class="col">
			<h2 class="head text-light">Latest Releases</h2>
			<hr>
		</div>
	</div>

	<div class="row mb-5">
		<?php foreach($kategoriGames as $game) : ?>
			<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 mt-4">
				<div class="card">
					...
					<div class="card-body">
						...
						<h6 class="text-right text-warning price mt-4">Rp.<?= number_format($game['price'], 2, ', ', '.'); ?></h6>
